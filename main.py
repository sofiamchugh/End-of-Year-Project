...
from azure_config import config, blob_to_data, init_batch_client, get_job_id
from util import make_safe_task_id, url_as_blob_name
...
/mnt/batch/tasks/shared/venv/bin/python3 /mnt/batch/tasks/shared/repo/worker.py {node.url} {node.parent} {crawl_delay}'
"""
